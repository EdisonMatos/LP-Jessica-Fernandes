  ...
  return (
    <>
      <div id="home">
        {/* mobile */}
        <div
          className="w-full bg-center bg-repeat bg-cover font-mainFont desktop1:pt-[45px] bg-[#12181E] desktop1:hidden"
          // style={{
          //   backgroundImage: `url(${content.texts.hero.backgroundPerson})`,
          // }}
        >
          <div className="relative z-10 flex w-fu text-labelButtons bg-opacity-0 items-left">
            <div className="w-full text-secondary justify-evenly">
              <div className="h-[50px] desktop1:h-[140px]" />
              <div className="flex flex-col-reverse gap-[10px] desktop1:flex-row desktop1:justify-between mx-auto w-[90%] max-w-[1215px] items-center pb-[64px] pt-[40px] desktop1:pt-[0px] desktop1:pb-[0px]">
                <div className="flex  flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]  ">
                  <div className="flex justify-center w-auto text-center desktop1:justify-start desktop1:text-left font-secondFont text-paragraph4">
                    <p className="mb-[16px] bg-minititle text-labelButtons bg-opacity-100 rounded-md px-[16px] py-[6px] inline-block text-paragraph2">
                    ...
                    {/* {appDownloadButtons && (
                      <MotionDivDownToUp>
                        <div className="flex flex-col items-center desktop1:items-start">
                          <p className="mb-[20px] mt-[60px] text-labelButtons  text-center">
                ...
                <div className="flex justify-center w-full tablet1:w-full desktop1:w-[35%] ">
                  <div className="relative flex items-end justify-center w-full desktop2:justify-end">
                    <img
                      ...
                      width="467"
                      height="847"
                      class="h-full relative desktop1:hidden"
                    />
                  </div>
                </div>
              </div>
        ...
        >
          <SectionArea paddingTopAndBottom={false} className="relative">
            <div className="absolute inset-0 w-[60%] h-full bg-gradient-to-r from-darker to-transparent" />
